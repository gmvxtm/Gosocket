...
export async function listPendingRequests(onlyIds = null) {
...
export async function markFailed(failures) {
...
export async function createLocalGroup(group) {
  const result = await pool.query(`
...
export async function readGroupStore() {
